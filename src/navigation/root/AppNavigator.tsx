...
import { normalizeSupportedLanguageCode } from '../../features/language/services/languageService';
...
export default function AppNavigator() {
  ...
  useEffect(() => {
    const nextLanguage = normalizeSupportedLanguageCode(authUser?.data?.languageCode);
    ...
    setLanguage(nextLanguage).catch(error => {
      console.warn('Unable to apply user language preference:', error);
    });
  }, [authUser?.data?.languageCode, language, setLanguage]);
