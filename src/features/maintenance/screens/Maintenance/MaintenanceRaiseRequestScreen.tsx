...
const ensureVoiceEmitterCompatibility = () => {
  ...
  if (
    typeof voiceModule.addListener !==
    'function'
  ) {
  ...
  if (
    typeof voiceModule.removeListeners !==
    'function'
  ) {
...
export default function MaintenanceRaiseRequestScreen({
  navigation,
  route,
}: any) {
   ...
   *
   * New:
   *   user = { userId, residentId, ... }
   *
   * Old:
   *   user = { data: { userId, residentId, ... } }
   */
  const userData =
    user?.data ?? user ?? null;
  ...
  const serviceLabel: string =
    ...
    t(
      'maintenance.mobile.raise.defaultServiceLabel',
      'General Support',
    );
  ...
  useEffect(() => {
    ...
    Voice.onSpeechError = () => {
      ...
      Alert.alert(
        t(
          'maintenance.mobile.raise.speechErrorTitle',
          'Speech Error',
        ),
        t(
      ...
      try {
        ...
        const granted =
          await PermissionsAndroid.request(
            ...
            {
              title: t(
                'maintenance.mobile.raise.microphonePermissionTitle',
              ...
              buttonPositive: t(
                'maintenance.mobile.raise.allow',
                'Allow',
              ),
              buttonNegative: t(
                'maintenance.mobile.raise.deny',
                'Deny',
              ),
            },
          );
  ...
  const startListening = async () => {
    if (!Voice) {
      Alert.alert(
        t(
          'maintenance.mobile.raise.speechToTextTitle',
          'Speech To Text',
        ),
        t(
    ...
    try {
      ...
      if (!micAllowed) {
        Alert.alert(
          t(
            'maintenance.mobile.raise.permissionRequiredTitle',
            'Permission Required',
          ),
          t(
      ...
      Alert.alert(
        ...
        e?.message ||
          t(
            'maintenance.mobile.raise.couldNotStartVoice',
  ...
  const onSave = async () => {
    ...
    if (!issueSummary) {
      Alert.alert(
        t(
          'maintenance.mobile.raise.validationTitle',
          'Validation',
        ),
        t(
          'maintenance.mobile.raise.problemDescriptionRequired',
    ...
    if (
      ...
      Alert.alert(
        ...
        t(
          'maintenance.mobile.raise.problemDescriptionInvalid',
    ...
    if (!residentId || !createdBy) {
      Alert.alert(
        ...
        t(
          'maintenance.mobile.raise.residentNotFound',
    ...
    if (!apartmentUnit) {
      Alert.alert(
        ...
        t(
          'maintenance.mobile.raise.apartmentNotFound',
          'Apartment information not found.',
        ),
      );
    ...
    if (!residentMobile) {
      Alert.alert(
        ...
        t(
          'maintenance.mobile.raise.contactNotFound',
          'Resident contact number not found.',
        ),
      );
    ...
    try {
      ...
      Alert.alert(
        ...
        e?.message ||
          t(
            'maintenance.mobile.raise.createRequestError',
  ...
  return (
    <ScreenWrapper
      title={t(
        'maintenance.mobile.raiseRequest',
        ...
        >
          <View style={styles.card}>
            <Text style={styles.label}>
              {t(
                'maintenance.mobile.raise.serviceType',
                'Service Type',
              )}
            </Text>
            ...
            <Text style={styles.label}>
              {t(
                'maintenance.mobile.raise.problemDescription',
                'Problem Description',
              )}
            </Text>
            ...
            <TextInput
              ...
              placeholder={t(
                'maintenance.mobile.raise.describeIssue',
                'Describe the issue',
              )}
              multiline
            />
            ...
            <View style={styles.modeRow}>
              ...
              >
                ...
                >
                  {t(
                    'maintenance.mobile.raise.write',
                    'Write',
                  )}
                </Text>
              </TouchableOpacity>
              ...
              {isVoiceSupported ? (
                ...
                >
                  ...
                  >
                    {t(
                      'maintenance.mobile.raise.speak',
                      'Speak',
                    )}
                  </Text>
                </TouchableOpacity>
              ...
              inputMode ===
                ...
                >
                  ...
                  >
                    {isListening
                      ? t(
                          'maintenance.mobile.raise.stop',
                          'Stop',
                        )
                      : t(
                          'maintenance.mobile.raise.startVoice',
                          'Start Voice',
                        )}
                  </Text>
                </TouchableOpacity>
            ...
            <Text style={styles.label}>
              {t(
                'maintenance.mobile.raise.preferredDateTime',
                'Preferred Date & Time',
              )}
            </Text>
            ...
            >
              ...
              >
                {preferredDateTime
                  ...
                  : t(
                      'maintenance.mobile.raise.selectDateTime',
            ...
            <Text style={styles.label}>
              {t(
                'maintenance.mobile.raise.apartmentDetails',
                'Apartment Details',
              )}
            </Text>
            ...
            <Text style={styles.label}>
              {t(
                'maintenance.mobile.raise.contactNumber',
                'Contact Number',
              )}
            </Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {t(
                'maintenance.mobile.raise.successTitle',
            ...
            >
              <Text
                style={
                  styles.successActionPrimaryText
                }
              >
                {t(
                  'maintenance.mobile.raise.selectTechnician',
                  'Select Technician',
                )}
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                style={
                  styles.successActionSecondaryText
                }
              >
                {t(
                  'maintenance.mobile.raise.moveToHistory',
                  'Move to History',
                )}
              </Text>
            </TouchableOpacity>
